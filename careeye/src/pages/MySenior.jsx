  ...
  return (
    <div className="mysenior-container">
      ...
      <div className="mysenior-card-wrapper">
        ...
        {/* 시니어 등록하기 */}
        <div
          className="mysenior-card"
          onClick={() => navigate("/my-senior/register")}
        >
          <img
            src="/mysenior/senior.png"
            alt="시니어 등록"
            className="mysenior-img"
          />
          <p>시니어 등록하기</p>
        </div>
        ...
        <div
          className="mysenior-card"
          onClick={() => navigate("/my-senior/info")}
        >
          <img
            src="/mysenior/scope.png"
            alt="시니어 정보 조회"
            className="mysenior-img"
          />
          <p>시니어 정보 조회</p>
